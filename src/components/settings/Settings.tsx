                    ...
                    <div className="card-body">
                        ...
                        <div className="form-group">
                            <label>
                                ...
                                <input type="number" className="form-control" name="socketPort" ref={register({ required: true })} min="1000" max="99999" placeholder="ex : 2319" defaultValue={config.socketPort} />
                            </label>
                            <small className="form-text text-muted">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veritatis.</small>
